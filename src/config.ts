...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/anime-study-banner.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	...
	links: [
		{
			...
			url: "https://github.com/huangpenguin",
		},
	],
};
